...
<div class="wrap isload">
  ...
  <div class="pic_bn"> {pboot:sort scode={sort:tcode}}<img class="pic_bn_img" src="[sort:pic]" />{/pboot:sort}
    <div class="pic_text"> <img src="{pboot:sitedomain}/skin/images/inbt_1.png" /> </div>
  ...
  <div class="html_cont">
    ...
    <div class="history">
      ...
      <div class="history_con">
        ...
        <div {pboot:if([list:i]%2==0)}class="history_div1"{else}class="history_div"{/pboot:if}>
          <div class="history_year" style="display:none"> <span>[list:ext_yue]<b>月</b></span> <i>[list:ext_nian]年</i> </div>
          <div class="history_cont">
            <h3>[list:title]</h3>
            [list:content drophtml=1 dropblank=1]
            <i class="iconfont {pboot:if([list:i]%2==0)}icon-sanjiao{else}icon-sanjiao-copy-copy-copy{/pboot:if}"></i> </div>
          <div class="history_year" style="display:block"> <span>[list:ext_yue]<b>月</b></span> <i>[list:ext_nian]年</i> </div>
        </div>
        {/pboot:list}
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function scroll_js() {
			...
			$(".history_div,.history_div1").each(function() {
