...
<div class="wrap isload">
  ...
  <!--end-->
  <div class="pic_bn"> {pboot:sort scode=1}<img class="pic_bn_img" src="[sort:pic]" />{/pboot:sort}
  ...
  <div class="m_pic_bn"> {pboot:sort scode=1}<img src="[sort:ico]" />{/pboot:sort} </div>
  <div class="html_cont">
    ...
    <div class="html_left">
      <ul>
        ...
        <li> <a href="[search:link]">
          <div class="img_text" style="width: 100%;float: none;">
            <h3>[search:title]</h3>
            <div class="img_text1"> [search:description lencn=80] </div>
            <div class="img_data"> [search:date style=Y-m-d] </div>
          </div>
          </a> </li>
        {/pboot:search}
      </ul>
